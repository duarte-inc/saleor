...
_DEFAULT_CLIENT_HOSTS = "localhost,127.0.0.1,ksgameshop.herokuapp.com"
...
INTERNAL_IPS = get_list(os.environ.get("INTERNAL_IPS", "127.0.0.1","ksgameshop.herokuapp.com"))
